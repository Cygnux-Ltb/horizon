...
public class FastMarketData extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final BinaryMessageEncoder<FastMarketData> ENCODER = new BinaryMessageEncoder<FastMarketData>(MODEL$,
			SCHEMA$);

	private static final BinaryMessageDecoder<FastMarketData> DECODER = new BinaryMessageDecoder<FastMarketData>(MODEL$,
			SCHEMA$);
	 ...
	 */
	public static FastMarketData fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
	 ...
	 */
	public FastMarketData(java.lang.Long timestamp, java.lang.Integer instrumentId, java.lang.String instrumentCode,
			...
			java.lang.Integer bidVolumes1, java.lang.Integer bidVolumes2, java.lang.Integer bidVolumes3,
			java.lang.Integer bidVolumes4, java.lang.Integer bidVolumes5, java.lang.Long askPrices1,
			java.lang.Long askPrices2, java.lang.Long askPrices3, java.lang.Long askPrices4, java.lang.Long askPrices5,
			java.lang.Integer askVolumes1, java.lang.Integer askVolumes2, java.lang.Integer askVolumes3,
			java.lang.Integer askVolumes4, java.lang.Integer askVolumes5) {
	 ...
	 */
	public static io.horizon.market.data.avro.FastMarketData.Builder newBuilder(
			io.horizon.market.data.avro.FastMarketData.Builder other) {
		if (other == null) {
			return new io.horizon.market.data.avro.FastMarketData.Builder();
		} else {
	...
	/**
	 * Creates a new FastMarketData RecordBuilder by copying an existing
	 * FastMarketData instance.
	 * 
	 * @param other The existing instance to copy.
	 * @return A new FastMarketData RecordBuilder
	 */
	public static io.horizon.market.data.avro.FastMarketData.Builder newBuilder(
			io.horizon.market.data.avro.FastMarketData other) {
		if (other == null) {
			return new io.horizon.market.data.avro.FastMarketData.Builder();
		} else {
			return new io.horizon.market.data.avro.FastMarketData.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FastMarketData>
		...
		public FastMarketData build() {
			try {
				...
				record.bidVolumes1 = fieldSetFlags()[11] ? this.bidVolumes1
						: (java.lang.Integer) defaultValue(fields()[11]);
				record.bidVolumes2 = fieldSetFlags()[12] ? this.bidVolumes2
						: (java.lang.Integer) defaultValue(fields()[12]);
				record.bidVolumes3 = fieldSetFlags()[13] ? this.bidVolumes3
						: (java.lang.Integer) defaultValue(fields()[13]);
				record.bidVolumes4 = fieldSetFlags()[14] ? this.bidVolumes4
						: (java.lang.Integer) defaultValue(fields()[14]);
				record.bidVolumes5 = fieldSetFlags()[15] ? this.bidVolumes5
				...
				record.askVolumes1 = fieldSetFlags()[21] ? this.askVolumes1
						: (java.lang.Integer) defaultValue(fields()[21]);
				record.askVolumes2 = fieldSetFlags()[22] ? this.askVolumes2
						: (java.lang.Integer) defaultValue(fields()[22]);
				record.askVolumes3 = fieldSetFlags()[23] ? this.askVolumes3
						: (java.lang.Integer) defaultValue(fields()[23]);
				record.askVolumes4 = fieldSetFlags()[24] ? this.askVolumes4
						: (java.lang.Integer) defaultValue(fields()[24]);
				record.askVolumes5 = fieldSetFlags()[25] ? this.askVolumes5
	...
	private static final org.apache.avro.io.DatumWriter<FastMarketData> WRITER$ = (org.apache.avro.io.DatumWriter<FastMarketData>) MODEL$
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<FastMarketData> READER$ = (org.apache.avro.io.DatumReader<FastMarketData>) MODEL$
