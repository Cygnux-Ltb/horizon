...
public class MarketDataSubscribeReply extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0 -> status = (io.horizon.market.transport.enums.SubscribeStatus) value$;
            case 1 -> successInstrumentCodes = (java.util.List<String>) value$;
            case 2 -> failInstrumentCodes = (java.util.List<String>) value$;
            case 3 -> msg = value$ != null ? value$.toString() : null;
            default -> throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    }
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in)
        ...
        if (fieldOrder == null) {
            ...
            if (a1 == null) {
                a1 = new SpecificData.Array<>((int) size1, SCHEMA$.getField("failInstrumentCodes").schema());
            ...
            for (int i = 0; i < 4; i++) {
                switch (fieldOrder[i].pos()) {
                    case 0 -> this.status = io.horizon.market.transport.enums.SubscribeStatus.values()[in.readEnum()];
                    case 1 -> {
                        long size0 = in.readArrayStart();
                        java.util.List<String> a0 = this.successInstrumentCodes;
                        if (a0 == null) {
                            a0 = new SpecificData.Array<String>((int) size0, SCHEMA$.getField("successInstrumentCodes").schema());
                            this.successInstrumentCodes = a0;
                        } else a0.clear();
                    ...
                    case 2 -> {
                        long size1 = in.readArrayStart();
                        java.util.List<String> a1 = this.failInstrumentCodes;
                        if (a1 == null) {
                            a1 = new SpecificData.Array<String>((int) size1, SCHEMA$.getField("failInstrumentCodes").schema());
                            this.failInstrumentCodes = a1;
                        } else a1.clear();
