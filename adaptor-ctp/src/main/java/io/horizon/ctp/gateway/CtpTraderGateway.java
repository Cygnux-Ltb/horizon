...
public class CtpTraderGateway implements Closeable {
	...
	// 交易请求ID
	private volatile int traderRequestId = 0;
	...
	class FtdcTraderCallback extends FtdcCallback {
		 ...
		 * 认证回调
		 * 
		 * @param CThostFtdcRspAuthenticateField
		 */
		 ...
		 * 撤单错误回调: 2
		 * 
		 * @param CThostFtdcOrderActionField
		 */
