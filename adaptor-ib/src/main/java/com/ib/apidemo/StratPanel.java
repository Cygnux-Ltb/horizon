...
public class StratPanel extends StackPanel implements IHistoricalDataHandler, IRealTimeBarHandler {
    ...
    static class HPanel extends HorzPanel {
        @Override
    ...
    private static QueryLength getQueryLength(BarSize barSize) {
        return switch (barSize) {
            case _1_secs -> new QueryLength(1, DurationUnit.SECOND);
            case _5_secs -> new QueryLength(5, DurationUnit.SECOND);
            case _10_secs -> new QueryLength(10, DurationUnit.SECOND);
            case _15_secs -> new QueryLength(15, DurationUnit.SECOND);
            case _30_secs -> new QueryLength(30, DurationUnit.SECOND);
            case _1_min -> new QueryLength(60, DurationUnit.SECOND);
            case _2_mins -> new QueryLength(120, DurationUnit.SECOND);
            case _3_mins -> new QueryLength(180, DurationUnit.SECOND);
            case _5_mins -> new QueryLength(300, DurationUnit.SECOND);
            case _10_mins -> new QueryLength(600, DurationUnit.SECOND);
            case _15_mins -> new QueryLength(900, DurationUnit.SECOND);
            case _20_mins -> new QueryLength(1200, DurationUnit.SECOND);
            case _30_mins -> new QueryLength(1800, DurationUnit.SECOND);
            case _1_hour -> new QueryLength(3600, DurationUnit.SECOND);
            case _4_hours -> new QueryLength(14400, DurationUnit.SECOND);
            case _1_day -> new QueryLength(1, DurationUnit.DAY);
            case _1_week -> new QueryLength(1, DurationUnit.WEEK);
            default -> null;
        };
    }
}
