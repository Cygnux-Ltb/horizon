...
class Builder implements ObjectOutput {
    ...
    public void send(List<TagValue> miscOptions) throws EClientException {
        String miscOptionsString = Optional.ofNullable(miscOptions).orElse(new ArrayList<>()).stream().
    ...
    @Override
    public void writeBytes(@Nonnull String arg0) throws IOException {
        send(arg0);
    }
    ...
    @Override
    public void writeChars(@Nonnull String arg0) throws IOException {
        send(arg0);
    }
    ...
    @Override
    public void writeUTF(@Nonnull String arg0) throws IOException {
        send(arg0);
    }
