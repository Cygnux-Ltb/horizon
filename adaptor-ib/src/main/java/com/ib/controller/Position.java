...
//	public void unrealPnl(double v) 	{ m_unrealPnl = v;}
	...
	public Position(Contract contract, String account, double position, double marketPrice, double marketValue,
			double averageCost, double unrealPnl, double realPnl) {
		m_contract = contract;
		m_account = account;
		m_position = position;
