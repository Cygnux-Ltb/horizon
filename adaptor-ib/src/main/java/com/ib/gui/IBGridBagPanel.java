...
class IBGridBagPanel extends JPanel {
	...
	public void SetObjectPlacement(Component c, int x, int y, int w, int h, int xGrow, int yGrow, int anchor,
			int fill) {
	...
	private void addToPane(Component c, int x, int y, int w, int h, int xGrow, int yGrow, Insets insets) {
		addToPane(c, x, y, w, h, xGrow, yGrow, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets);
	}

	private void addToPane(Component c, int x, int y, int w, int h, int xGrow, int yGrow, int anchor, int fill,
			Insets insets) {
