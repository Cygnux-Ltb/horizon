...
public class Main {
	...
	public static void main(String args[]) throws Exception {
		Spot spot = new Spot();
		/*
		 * ### public data endpoint, call send_public_request ##### get klines
		 */

		spot.klines("BTCUSDT", "1d", "10");

		/*
		 * get account informtion if you can see the account details, then the API
		...
		/*
		 * place an order if you see order response, then the parameters setting is
		 * correct
		 */
