...
public class DtoQueryBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7871583921443718582L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DtoQueryBalance\",\"namespace\":\"io.horizon.trader.transport.inbound\",\"doc\":\"* 查询账户余额\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<DtoQueryBalance> ENCODER =
      new BinaryMessageEncoder<DtoQueryBalance>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DtoQueryBalance> DECODER =
      new BinaryMessageDecoder<DtoQueryBalance>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<DtoQueryBalance> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoQueryBalance> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoQueryBalance> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DtoQueryBalance>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DtoQueryBalance to a ByteBuffer.
  ...
  /**
   * Deserializes a DtoQueryBalance from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DtoQueryBalance instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DtoQueryBalance fromByteBuffer(
   ...
   */
  public DtoQueryBalance(java.lang.Long generateTime, java.lang.Long sendTime, java.lang.String brokerId, java.lang.Integer accountId, java.lang.Integer subAccountId, java.lang.Integer strategyId, java.lang.String operatorId) {
   ...
   */
  public DtoQueryBalance setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryBalance setOperatorId(java.lang.String value) {
    this.operatorId = value;
    return this;
  }

  /**
   * Creates a new DtoQueryBalance RecordBuilder.
   * @return A new DtoQueryBalance RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryBalance.Builder newBuilder() {
    return new io.horizon.trader.transport.inbound.DtoQueryBalance.Builder();
  }

  /**
   * Creates a new DtoQueryBalance RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DtoQueryBalance RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryBalance.Builder newBuilder(io.horizon.trader.transport.inbound.DtoQueryBalance.Builder other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoQueryBalance.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoQueryBalance.Builder(other);
    }
  }

  /**
   * Creates a new DtoQueryBalance RecordBuilder by copying an existing DtoQueryBalance instance.
   * @param other The existing instance to copy.
   * @return A new DtoQueryBalance RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryBalance.Builder newBuilder(io.horizon.trader.transport.inbound.DtoQueryBalance other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoQueryBalance.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoQueryBalance.Builder(other);
  ...
  /**
   * RecordBuilder for DtoQueryBalance instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DtoQueryBalance>
    implements org.apache.avro.data.RecordBuilder<DtoQueryBalance> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoQueryBalance.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DtoQueryBalance instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoQueryBalance other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryBalance.Builder clearOperatorId() {
      operatorId = null;
    ...
    @Override
    public DtoQueryBalance build() {
      try {
        DtoQueryBalance record = new DtoQueryBalance();
  ...
  private static final org.apache.avro.io.DatumWriter<DtoQueryBalance>
    WRITER$ = (org.apache.avro.io.DatumWriter<DtoQueryBalance>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DtoQueryBalance>
    READER$ = (org.apache.avro.io.DatumReader<DtoQueryBalance>)MODEL$.createDatumReader(SCHEMA$);
