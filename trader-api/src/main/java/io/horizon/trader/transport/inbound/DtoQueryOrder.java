...
public class DtoQueryOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4643446868191765159L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DtoQueryOrder\",\"namespace\":\"io.horizon.trader.transport.inbound\",\"doc\":\"* 查询订单\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\",\"default\":0},{\"name\":\"sendTime\",\"type\":\"long\",\"default\":0},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<DtoQueryOrder> ENCODER =
      new BinaryMessageEncoder<DtoQueryOrder>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DtoQueryOrder> DECODER =
      new BinaryMessageDecoder<DtoQueryOrder>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<DtoQueryOrder> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoQueryOrder> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoQueryOrder> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DtoQueryOrder>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DtoQueryOrder to a ByteBuffer.
  ...
  /**
   * Deserializes a DtoQueryOrder from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DtoQueryOrder instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DtoQueryOrder fromByteBuffer(
   ...
   */
  public DtoQueryOrder(java.lang.Long generateTime, java.lang.Long sendTime, java.lang.Long ordSysId, java.lang.String exchangeCode, java.lang.String instrumentCode, java.lang.String brokerId, java.lang.Integer accountId, java.lang.Integer subAccountId, java.lang.Integer strategyId, java.lang.String operatorId) {
   ...
   */
  public DtoQueryOrder setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setOrdSysId(long value) {
    this.ordSysId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoQueryOrder setOperatorId(java.lang.String value) {
    this.operatorId = value;
    return this;
  }

  /**
   * Creates a new DtoQueryOrder RecordBuilder.
   * @return A new DtoQueryOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryOrder.Builder newBuilder() {
    return new io.horizon.trader.transport.inbound.DtoQueryOrder.Builder();
  }

  /**
   * Creates a new DtoQueryOrder RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DtoQueryOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryOrder.Builder newBuilder(io.horizon.trader.transport.inbound.DtoQueryOrder.Builder other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoQueryOrder.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoQueryOrder.Builder(other);
    }
  }

  /**
   * Creates a new DtoQueryOrder RecordBuilder by copying an existing DtoQueryOrder instance.
   * @param other The existing instance to copy.
   * @return A new DtoQueryOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoQueryOrder.Builder newBuilder(io.horizon.trader.transport.inbound.DtoQueryOrder other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoQueryOrder.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoQueryOrder.Builder(other);
  ...
  /**
   * RecordBuilder for DtoQueryOrder instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DtoQueryOrder>
    implements org.apache.avro.data.RecordBuilder<DtoQueryOrder> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoQueryOrder.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DtoQueryOrder instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoQueryOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoQueryOrder.Builder clearOperatorId() {
      operatorId = null;
    ...
    @Override
    public DtoQueryOrder build() {
      try {
        DtoQueryOrder record = new DtoQueryOrder();
  ...
  private static final org.apache.avro.io.DatumWriter<DtoQueryOrder>
    WRITER$ = (org.apache.avro.io.DatumWriter<DtoQueryOrder>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DtoQueryOrder>
    READER$ = (org.apache.avro.io.DatumReader<DtoQueryOrder>)MODEL$.createDatumReader(SCHEMA$);
