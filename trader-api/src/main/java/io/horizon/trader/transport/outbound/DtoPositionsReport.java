...
public class DtoPositionsReport extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4017705095447150873L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DtoPositionsReport\",\"namespace\":\"io.horizon.trader.transport.outbound\",\"doc\":\"* 持仓回报\",\"fields\":[{\"name\":\"epochMillis\",\"type\":\"long\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"investorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"qty\",\"type\":\"int\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<DtoPositionsReport> ENCODER =
      new BinaryMessageEncoder<DtoPositionsReport>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DtoPositionsReport> DECODER =
      new BinaryMessageDecoder<DtoPositionsReport>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<DtoPositionsReport> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoPositionsReport> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoPositionsReport> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DtoPositionsReport>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DtoPositionsReport to a ByteBuffer.
  ...
  /**
   * Deserializes a DtoPositionsReport from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DtoPositionsReport instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DtoPositionsReport fromByteBuffer(
   ...
   */
  public DtoPositionsReport(java.lang.Long epochMillis, java.lang.String brokerId, java.lang.String investorId, java.lang.String exchangeCode, java.lang.String instrumentCode, java.lang.Integer qty) {
   ...
   */
  public DtoPositionsReport setEpochMillis(long value) {
   ...
   * @param value the value to set.
   */
  public DtoPositionsReport setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoPositionsReport setInvestorId(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoPositionsReport setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoPositionsReport setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoPositionsReport setQty(int value) {
    this.qty = value;
    return this;
  }

  /**
   * Creates a new DtoPositionsReport RecordBuilder.
   * @return A new DtoPositionsReport RecordBuilder
   */
  public static io.horizon.trader.transport.outbound.DtoPositionsReport.Builder newBuilder() {
    return new io.horizon.trader.transport.outbound.DtoPositionsReport.Builder();
  }

  /**
   * Creates a new DtoPositionsReport RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DtoPositionsReport RecordBuilder
   */
  public static io.horizon.trader.transport.outbound.DtoPositionsReport.Builder newBuilder(io.horizon.trader.transport.outbound.DtoPositionsReport.Builder other) {
    if (other == null) {
      return new io.horizon.trader.transport.outbound.DtoPositionsReport.Builder();
    } else {
      return new io.horizon.trader.transport.outbound.DtoPositionsReport.Builder(other);
    }
  }

  /**
   * Creates a new DtoPositionsReport RecordBuilder by copying an existing DtoPositionsReport instance.
   * @param other The existing instance to copy.
   * @return A new DtoPositionsReport RecordBuilder
   */
  public static io.horizon.trader.transport.outbound.DtoPositionsReport.Builder newBuilder(io.horizon.trader.transport.outbound.DtoPositionsReport other) {
    if (other == null) {
      return new io.horizon.trader.transport.outbound.DtoPositionsReport.Builder();
    } else {
      return new io.horizon.trader.transport.outbound.DtoPositionsReport.Builder(other);
  ...
  /**
   * RecordBuilder for DtoPositionsReport instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DtoPositionsReport>
    implements org.apache.avro.data.RecordBuilder<DtoPositionsReport> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.transport.outbound.DtoPositionsReport.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DtoPositionsReport instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.transport.outbound.DtoPositionsReport other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.epochMillis)) {
        this.epochMillis = data().deepCopy(fields()[0].schema(), other.epochMillis);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setEpochMillis(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearEpochMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setInvestorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearInvestorId() {
      investorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder setQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.outbound.DtoPositionsReport.Builder clearQty() {
      fieldSetFlags()[5] = false;
      return this;
    }

    @Override
    public DtoPositionsReport build() {
      try {
        DtoPositionsReport record = new DtoPositionsReport();
  ...
  private static final org.apache.avro.io.DatumWriter<DtoPositionsReport>
    WRITER$ = (org.apache.avro.io.DatumWriter<DtoPositionsReport>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DtoPositionsReport>
    READER$ = (org.apache.avro.io.DatumReader<DtoPositionsReport>)MODEL$.createDatumReader(SCHEMA$);
