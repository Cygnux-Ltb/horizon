...
public class DtoCancelOrder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5748159438255460260L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DtoCancelOrder\",\"namespace\":\"io.horizon.trader.transport.inbound\",\"doc\":\"* 撤单\",\"fields\":[{\"name\":\"generateTime\",\"type\":\"long\"},{\"name\":\"sendTime\",\"type\":\"long\"},{\"name\":\"ordSysId\",\"type\":\"long\"},{\"name\":\"immediately\",\"type\":\"boolean\",\"default\":true},{\"name\":\"delayMillis\",\"type\":\"long\",\"default\":0},{\"name\":\"exchangeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"instrumentCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"int\"},{\"name\":\"subAccountId\",\"type\":\"int\"},{\"name\":\"strategyId\",\"type\":\"int\"},{\"name\":\"operatorId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"msg\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<DtoCancelOrder> ENCODER =
      new BinaryMessageEncoder<DtoCancelOrder>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DtoCancelOrder> DECODER =
      new BinaryMessageDecoder<DtoCancelOrder>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<DtoCancelOrder> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoCancelOrder> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DtoCancelOrder> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DtoCancelOrder>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DtoCancelOrder to a ByteBuffer.
  ...
  /**
   * Deserializes a DtoCancelOrder from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DtoCancelOrder instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DtoCancelOrder fromByteBuffer(
   ...
   */
  public DtoCancelOrder setGenerateTime(long value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setSendTime(long value) {
    this.sendTime = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setOrdSysId(long value) {
    this.ordSysId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setImmediately(boolean value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setDelayMillis(long value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setExchangeCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setInstrumentCode(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setBrokerId(java.lang.String value) {
    this.brokerId = value;
    return this;
  }
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setSubAccountId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setStrategyId(int value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setOperatorId(java.lang.String value) {
   ...
   * @param value the value to set.
   */
  public DtoCancelOrder setMsg(java.lang.String value) {
    this.msg = value;
    return this;
  }

  /**
   * Creates a new DtoCancelOrder RecordBuilder.
   * @return A new DtoCancelOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoCancelOrder.Builder newBuilder() {
    return new io.horizon.trader.transport.inbound.DtoCancelOrder.Builder();
  }

  /**
   * Creates a new DtoCancelOrder RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DtoCancelOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoCancelOrder.Builder newBuilder(io.horizon.trader.transport.inbound.DtoCancelOrder.Builder other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoCancelOrder.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoCancelOrder.Builder(other);
    }
  }

  /**
   * Creates a new DtoCancelOrder RecordBuilder by copying an existing DtoCancelOrder instance.
   * @param other The existing instance to copy.
   * @return A new DtoCancelOrder RecordBuilder
   */
  public static io.horizon.trader.transport.inbound.DtoCancelOrder.Builder newBuilder(io.horizon.trader.transport.inbound.DtoCancelOrder other) {
    if (other == null) {
      return new io.horizon.trader.transport.inbound.DtoCancelOrder.Builder();
    } else {
      return new io.horizon.trader.transport.inbound.DtoCancelOrder.Builder(other);
  ...
  /**
   * RecordBuilder for DtoCancelOrder instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DtoCancelOrder>
    implements org.apache.avro.data.RecordBuilder<DtoCancelOrder> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoCancelOrder.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DtoCancelOrder instance
     * @param other The existing instance to copy.
     */
    private Builder(io.horizon.trader.transport.inbound.DtoCancelOrder other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.generateTime)) {
        this.generateTime = data().deepCopy(fields()[0].schema(), other.generateTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setGenerateTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearGenerateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setSendTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearSendTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setOrdSysId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearOrdSysId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setImmediately(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearImmediately() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setDelayMillis(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearDelayMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setExchangeCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearExchangeCode() {
      exchangeCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setInstrumentCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearInstrumentCode() {
      instrumentCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setBrokerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearBrokerId() {
      brokerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setSubAccountId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearSubAccountId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setStrategyId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearStrategyId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setOperatorId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearOperatorId() {
      operatorId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder setMsg(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.horizon.trader.transport.inbound.DtoCancelOrder.Builder clearMsg() {
      msg = null;
    ...
    @Override
    public DtoCancelOrder build() {
      try {
        DtoCancelOrder record = new DtoCancelOrder();
  ...
  private static final org.apache.avro.io.DatumWriter<DtoCancelOrder>
    WRITER$ = (org.apache.avro.io.DatumWriter<DtoCancelOrder>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DtoCancelOrder>
    READER$ = (org.apache.avro.io.DatumReader<DtoCancelOrder>)MODEL$.createDatumReader(SCHEMA$);
